...
function js(done) {
  pump(
    [order(getJsFiles("v1"), { sourcemaps: true }), concat("main.min.js"), uglify(), dest("assets/built/", { sourcemaps: "." }), livereload()],
    handleError(done)
  );
}
...
function zipper(done) {
  ...
  pump([src(["**", "!node_modules", "!node_modules/**", "!dist", "!dist/**", "!yarn-error.log"]), zip(filename), dest("dist/")], handleError(done));
}
